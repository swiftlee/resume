  ...
  return [
    <>
      ...
      <svg
        ...
        fill="currentColor"
        aria-hidden="true"
        onClick={() => window.open("https://github.com/swiftlee", "_blank")}
      >
    ...
    <>
      ...
      <svg
        ...
        fill="currentColor"
        aria-hidden="true"
        onClick={() => window.open("https://www.linkedin.com/in/jonathan-c-837601b2/", "_blank")}
      >
    ...
    <>
      ...
      <svg
        ...
        fill="currentColor"
        aria-hidden="true"
        onClick={() => window.open("mailto:horizonman34@gmail.com", "_blank")}
      >
